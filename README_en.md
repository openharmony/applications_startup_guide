...
Configuration items locate business-application metadata through packageName, moduleName, and serviceName; the metadata must point to a `rawfile:*.json` agreement resource.
